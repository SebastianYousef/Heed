...
import se.kth.notiapp.MainActivity
import se.kth.notiapp.R
import se.kth.notiapp.capture.HoldBuffer
...
class Notifier(private val context: Context) {
    ...
    companion object {
        const val CHANNEL_ALERT = "noti_alert"
        const val CHANNEL_DIGEST = "noti_digest"
    ...
    fun ensureChannels() {
        ...
        system.createNotificationChannel(
            NotificationChannel(
                ...
                description = "Notifications notiApp judged worth interrupting you for."
    ...
    fun raise(held: HoldBuffer.Held, recordId: Long) {
        ...
        // not in notiApp. Falls back to our inbox if the PendingIntent has expired.

...
class HoldBuffer(
    ...
    data class Held(
        ...
        /**
         * Row id, written before the wait starts. Persisting up front means a held
         * notification survives the process being killed inside the window instead of
         * vanishing unrecorded.
         */
        val recordId: Long,
        /** True when this replaced an entry already in the window under the same key. */
